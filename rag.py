...
# GOOGLE_API_KEY = 'AIzaSyACdFbGn9GYVpe7fYlIoVJa8Pbtibhtwzo'
...
#     vector_db = Chroma(persist_directory="./chroma_db_nccn", embeddings_function=embeddings_function)
...
# while True:
#     print("----------------------------------------------------------------------------")
#     print("Enter Your Finding Course :- ")
#     query = input("Query: ")
...
# # Initialize HuggingFace embeddings with a specific model name
...
# vectorstore = Chroma.from_documents(documents=all_documents, embedding=embeddings, persist_directory="findcourseXYZ")
...
# # The query string for which you want to retrieve the relevant documents
# query = "What are the Information Technology Courses?"
